...
def _httpHandlerTestGet(httpClient, httpResponse):
    ...
    httpResponse.WriteResponseOk(None, "text/html", "UTF-8", content)
...
def _acceptWebSocketCallback(webSocket, httpClint):
    print("WS ACCEPT")
    webSocket.RecvTextCall
    k = _recvTextCallback
